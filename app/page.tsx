      ...
      <section className="border-b border-border bg-surface">
        <div className="wrap section-py">
          ...
          <div className="grid md:grid-cols-5 gap-10 items-start">
            ...
            <div className="md:col-span-3">
              <IndexedChart height={240} />
              <p className="text-xs font-sans text-ink-muted mt-3 leading-relaxed italic">
                Both indexed to 100 at inception (Nov 2025). Fund holds ~50% cash — significantly reducing drawdown vs raw BTC exposure.
              </p>
              <div className="mt-5">
        ...
        <div className="wrap section-py text-center">
          <ScrollReveal>
            ...
            <p className="text-white/80 font-sans text-base max-w-lg mx-auto mb-8 leading-relaxed">
              Applications for the 2025/26 academic year open at the University of Edinburgh Society Fair. We run <strong className="text-white">weekly sessions</strong> during term — join our community on WhatsApp to stay in the loop, or follow us on LinkedIn for market updates.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="https://chat.whatsapp.com/I4xZVTFqxCtBghGhUvGr21"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-white text-gold font-sans font-semibold text-sm px-6 py-3 hover:bg-white/90 transition-colors"
              >
